...
Windows 빌드 전 이 폴더 또는 `-ModelPath`로 지정한 폴더에 `schift-io/schift-ko-pii-v6` 모델 스냅샷을 둡니다. 모델 원본과 라이선스는 [Hugging Face 모델 페이지](https://huggingface.co/schift-io/schift-ko-pii-v6)에서 확인합니다.
